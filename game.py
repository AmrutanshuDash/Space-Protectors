...
#designing
pygame.display.set_caption("Welcome Space Warriors")
...
mixer.music.load('pics/background.wav')
mixer.music.play(-1)

#player
playerImage = pygame.image.load('pics/spaceship.png')
player_X = 370
player_Y = 523
player_Xchange = 0
...
for num in range(no_of_invaders):
    invaderImage.append(pygame.image.load('pics/alien.png'))
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                ...
                if bullet_state is "rest":
                    ...
                    bullet_sound = mixer.Sound('pics/bullet.wav')
                    bullet_sound.play()
        ...
        if invader_Y[i] >= 450:
            if abs(player_X-invader_X[i]) < 80:
                for j in range(no_of_invaders):
                    invader_Y[j] = 2000
                    explosion_sound = mixer.Sound('pics/explosion.wav')
